...
import { MoreHorizontal, Pencil, Trash2, Search, FileText, Layers, FolderKanban, Calendar, CreditCard, ArrowUpDown, Printer, Mail, Phone, Shield, RotateCcw, X, Info, User, Briefcase, Tag, Clock, CheckCircle, XCircle, ChevronRight, Package, Calculator, Paperclip } from 'lucide-react'
                                        ...
                                        <div className="flex items-center justify-end gap-0.5">
                                            {pyc.status === 'Chờ duyệt' && (
                                                <Button
                                                    ...
                                                    onClick={() => handleStatusChange(pyc.request_id, 'Đã duyệt')}
                                                    title="Phê duyệt"
                                                >
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="w-[180px] rounded-xl p-1.5 backdrop-blur-xl bg-card/95 border-border/50">
                                                    ...
                                                    <DropdownMenuItem
                                                        onClick={() => handleStatusChange(pyc.request_id, 'Từ chối')}
                                                    ...
                                                    <DropdownMenuItem
                                                        onClick={() => handleStatusChange(pyc.request_id, 'Cần chỉnh sửa')}
